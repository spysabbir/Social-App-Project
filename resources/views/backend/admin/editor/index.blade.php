    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <h4 class="card-title">Editor Panel</h4>
                <!-- View Modal -->
                <button type="button" class="btn btn-success btn-sm viewBtn" data-bs-toggle="modal" data-bs-target="#addModal">Create Editor</button>
                            ...
                            <div class="modal-body">
                                <div class="form-body">
                                    <form class="row g-3" method="POST" action="{{ route('backend.register') }}" id="createForm">
                                        ...
                                        <div class="col-12">
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary"><i class='bx bx-user'></i>Create Editor</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '.statusBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('backend.editor.status', ":id") }}";
        ...
        $(document).on('click', '.viewBtn', function () {
            var id = $(this).data('id');
            var url = "{{ route('backend.editor.view', ":id") }}";
            url = url.replace(':id', id)
            $.ajax({
                url: url,
                type: "GET",
